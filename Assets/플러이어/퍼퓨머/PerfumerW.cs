...
public class PerfumerW : SkillBase
{
    ...
    private float[] tenacities = { 30f, 35f, 40f, 45f }; // 강인함 %
    private float[] cooldowns = { 18f, 16f, 14f, 12f };
    private float[] manaCosts = { 110f, 110f, 110f, 110f };

    private float duration = 3f;
    private float auraRange = 5f; // 반경 500

    // 강인함 버프 활성화 여부 (EnemyStatus에서 참조)
