...
public class ZhongliW : SkillBase
{
    ...
    private float[] dmgReductions = { 20f, 25f, 30f, 35f }; // %
    private float[] expDamages = { 100f, 150f, 200f, 250f };
    ...
    void Explode(int idx)
    {
        ...
        foreach (Collider hit in hits)
        {
            ...
            if (eh != null)
            {
                ...
                Debug.Log($"옥홀 방패 폭발! 피해: {totalDamage}");
            }
