...
public class PerfumerQ : SkillBase
{
    ...
    private float[] heals = { 80f, 120f, 160f };
    private float[] cooldowns = { 5f, 5f, 4f };
    private float[] manaCosts = { 100f, 100f, 100f };
    private float apRatio = 0.6f;

    private PlayerStats playerStats;  // 시전자 본인
    private PlayerStats targetStats;  // 힐 대상 아군
