...
public class KakaruE : SkillBase
{
    ...
    private float[] damages = { 55f, 85f, 115f };
    ...
    protected override void OnUse()
    {
        ...
        foreach (Collider hit in hits)
        {
            ...
            if (eh != null)
            {
                ...
                Debug.Log($"필수의 수단 적중! 데미지: {totalDamage}");
                hitAny = true;
            }
    ...
    IEnumerator ApplyBuff()
    {
        ...
        Debug.Log($"필수의 수단 버프 적용! 이속 +{buffMoveSpeed * 100}% / 공속 +{buffAttackSpeed * 100}%");
        ...
        Debug.Log("필수의 수단 버프 종료, 원래 값 복귀");
    }
